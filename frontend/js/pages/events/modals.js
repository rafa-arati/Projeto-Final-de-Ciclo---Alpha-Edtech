...
export function setupModals() {
    ...
    try {
        // Modal de Filtros (eventos internos configurados por setupFilterModalEvents)
        // A função setupFilterModalEvents é chamada em eventHandlers.js,
        // que por sua vez é chamada em index.js. Isso garante que
        // ela execute após o modal de filtro ser adicionado ao DOM.
        // Não precisa chamar setupFilterModalEvents() aqui diretamente.
