...
async function handleLogin(event) {
    ...
    try {
        // Tenta fazer login via API (função loginUser provavelmente está em auth.js)
        const result = await loginUser(identifier, password, userType);

        // Verifica se o usuário é admin se selecionou o tipo admin (opcional, pode ser feito no backend também)
