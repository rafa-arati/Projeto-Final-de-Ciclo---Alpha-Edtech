...
// Importar a função loginUser do auth.js
...
function setupLoginEvents() {
    ...
    if (registerLink) {
        registerLink.addEventListener('click', function () {
            window.location.hash = '/register'; // Navegação para a rota de registro
        });
    }
}
...
export function renderLogin() {
    const appContainer = document.getElementById('app'); // Seleciona o container usando o ID 'app'
    ...
    document.getElementById('app').innerHTML = loginHTML; // Usa getElementById
    setupLoginEvents();
}